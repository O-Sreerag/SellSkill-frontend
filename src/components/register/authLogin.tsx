...
const AuthLogin = () => {
    ...
    const handleLogin = async () => {
        try {
            ...
            const response = await axios.post(`https://sellskill.hawkinvoice.online/auth/common/login`, { email, password })
    ...
    const handleResendEmail = async () => {
        ...
        try {
            const response = await axios.post('https://sellskill.hawkinvoice.online/auth/common/sendMail', {
                name,
                email: resendEmail,
                role
            });
